...
export class DREServer {
      ...
      try {
        switch (name) {
          case 'log_thought': {
            ...
            return this.handleLogThought(input);
          }
          ...
          case 'invalidate_assumption': {
            ...
            return this.handleInvalidateAssumption(input);
          }
  ...
  private handleLogThought(input: LogThoughtInput) {
  ...
  private handleInvalidateAssumption(input: InvalidateInput) {
